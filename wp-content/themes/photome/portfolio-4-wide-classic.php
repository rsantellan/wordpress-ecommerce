...
<div class="inner">
	...
	<div class="element grid classic4_cols <?php echo esc_attr($portfolio_item_set); ?>" data-type="<?php echo esc_attr($portfolio_item_set); ?>">
		...
		<div class="one_fourth gallery4 classic static filterable gallery_type animated<?php echo esc_attr($key+1); ?> portfolio_type" data-id="post-<?php echo esc_attr($key+1); ?>">
		<?php 
